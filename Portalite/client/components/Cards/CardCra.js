            ...
            <Card hoverable>
              <Row gutter={32}>
                <Col span={12}>
                  ...
                  <Row>
                    provision <b>{contract.res}€</b>
                    <Progress percent={70} status="normal" />
                  </Row>
                  <Row>
                    Charges sociales <b>{contract.chomage}€</b>
                ...
                <Col span={12}>
                  ...
                  <Row>
                    Net avant impot <b>{contract.prov}€</b>
                    <Progress percent={50} />
                  </Row>
                  <Row>
                    Reste a verser sur le mois <b>{contract.chomage}€</b>
